...
- To recompile the `dist/bundle.js` file, run `webpack` from within the project's root directory.

# Pear and Oak Tree Orchard Simulator

This app is based on the instructions below from Nashville Software School.
